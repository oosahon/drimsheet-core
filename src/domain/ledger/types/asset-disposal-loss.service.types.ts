...
import { IAssetDisposalLossAccount } from './expense-account.types';
import { TAssetDisposalLossLedgerCode } from './ledger-code.types';
...
export interface IAssetDisposalLossAccountService {
  createHeader(
