...
Drimsheet will support the following reporting for all three accounting domains:
...
_(This section will be expanded as we implement the mechanics of adjusting journal entries for specific Reporting Contexts)._
