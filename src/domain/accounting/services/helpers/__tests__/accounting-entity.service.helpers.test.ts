...
import accountingEntityServiceHelpers from '@domain/accounting/services/helpers/accounting-entity.service.helpers';
...
describe('accountingEntityServiceHelpers', () => {
  ...
  describe('validateExistingIndividualEntity', () => {
    it('does not query existing entities for a non-individual entity', async () => {
      await expect(
        accountingEntityServiceHelpers.validateExistingIndividualEntity(
          repo,
