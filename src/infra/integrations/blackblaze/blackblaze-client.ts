...
import IBlackblazeClient, {
  ICreateBlackblazeUploadPayload,
} from '@app/file/contracts/blackblaze-client.contract';
...
export function makeBlackblazeClient(
  ...
  return Object.freeze({
    async createUpload({ key, contentType }: ICreateBlackblazeUploadPayload) {
      try {
...
let configuredClient: IBlackblazeClient | undefined;

const blackblazeClient: IBlackblazeClient = Object.freeze({
  createUpload(payload: ICreateBlackblazeUploadPayload) {
