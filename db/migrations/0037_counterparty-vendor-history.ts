...
import { counterpartyVendorHistoryTable } from '../config/counterparties';
...
export async function up(pgm: MigrationBuilder): Promise<void> {
  pgm.createTable(counterpartyVendorHistoryTable, {
    id: {
      type: 'bigserial',
      primaryKey: true,
    },
  ...
  pgm.addConstraint(
    counterpartyVendorHistoryTable,
  ...
  pgm.createIndex(
    ...
    {
      name: 'counterparty_vendor_history_timeline_idx',
    }
  );
}

export async function down(pgm: MigrationBuilder): Promise<void> {
  pgm.dropTable(counterpartyVendorHistoryTable);
}
