...
import { counterpartyEmployerHistoryTable } from '../config/counterparties';
...
export async function up(pgm: MigrationBuilder): Promise<void> {
  pgm.createTable(counterpartyEmployerHistoryTable, {
    id: {
      type: 'bigserial',
      primaryKey: true,
    },
  ...
  pgm.addConstraint(
    counterpartyEmployerHistoryTable,
  ...
  pgm.createIndex(
    ...
    {
      name: 'counterparty_employer_history_timeline_idx',
    }
  );
}

export async function down(pgm: MigrationBuilder): Promise<void> {
  pgm.dropTable(counterpartyEmployerHistoryTable);
}
