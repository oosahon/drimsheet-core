...
| **6-7**   | **Bookkeeping Domain Service**    | The use case delegates to `bookkeepingServices.recordTransaction`, which creates balanced journal entries and returns domain events.                                         |
